...
namespace MvcPruebaAuroraCochesAWS.Services
{
    public class ServiceAWS
    {
        //NECESITAMOS EL NOMBRE DEL BUCKET, PERO EN UN LUGAR DE MANDAR UN STRING, VAMOS A REALIZARLO MAS PROFESIONAL
        private string bucketName;
        private IAmazonS3 awsClient;
        public ServiceAWS(IConfiguration configuration, IAmazonS3 client)
        {
        ...
        //LO QUE NOS VA A PEDIR ES EL NOMBRE DEL BUCKET, STREAM, Y UNA KEY/FILENAME
        //UNA VEZ SUBIDO, NOS DEVUELvE UNA RESPUESTA 200
        public async Task<bool> UploadFilesAsync(Stream stream, string fileName)
        {
            ...
            //DEBEMOS CAPTURAR UNA RESPUESTA MEDIANTE EL CLIENTE AWS, ENVIANDO EL REQUEST
        ...
        ////VAMO A DEVOLVER EL FILENAME SOLAMENTE PARA LUEGO LEER EL ARCHIVO POR CODIGO
        //public async Task<List<string>> GetFilesAsync()
        //{
        //    //DEVUELVE UNA COLECCION LLAMADA LIST VERSIONS DONDE ACCEDEMOS A LAS VERSIONES DE LOS ARCHIVOS
